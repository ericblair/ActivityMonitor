...
namespace ActivityMonitor.Repository
{
    ...
    {
        public bool DidSiteSendAMSGPMessagesOnLastWeekDay(string organisation, int daysSinceLastWeekDay)
        {
            ...
            if (_latestMsg > DateTime.Today.AddDays(- daysSinceLastWeekDay))
            {
