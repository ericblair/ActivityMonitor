...
namespace ActivityMonitorTests.RepositoryTests
{
    ...
    public class FindUnnotifiedSitesWithLateMigrationsTests
    {
        ...
        public void FindUnnotifiedSitesWithLateMigrations_NoSitesMatchCriteria_ReturnEmptyDictionary()
        {
            ...
            _mockContext.tbRPT_MigratingSites.AddObject(TestHelpers.PopulateTable.AddMigratingSitesDataRow("1234", DateTime.Today, null));
            _mockContext.tbRPT_MigratingSites.AddObject(TestHelpers.PopulateTable.AddMigratingSitesDataRow("2345", DateTime.Today.AddDays(-5), DateTime.Today));
        ...
        {
            _mockContext.tbRPT_MigratingSites.AddObject(TestHelpers.PopulateTable.AddMigratingSitesDataRow("1234", DateTime.Today.AddDays(-5), null));
            _mockContext.tbRPT_MigratingSites.AddObject(TestHelpers.PopulateTable.AddMigratingSitesDataRow("2345", DateTime.Today.AddDays(-6), null));
            _mockContext.tbRPT_MigratingSites.AddObject(TestHelpers.PopulateTable.AddMigratingSitesDataRow("3456", DateTime.Today.AddDays(-7), null));
